...
export class MarketingExportClient {
    ...
    protected processGetDaily(response: Response): Promise<DailyRes> {
        ...
        if (status === 200) {
            ...
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as DailyRes;
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DailyRes>(null as any);
    }

    getSites(): Promise<SitesRes> {
        let url_ = this.baseUrl + "/umbraco/api/MarketingExport/v1/sites";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetSites(response: Response): Promise<SitesRes> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as SitesRes;
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SitesRes>(null as any);
    }

    getSite(siteId: string): Promise<SiteRes> {
        let url_ = this.baseUrl + "/umbraco/api/MarketingExport/v1/sites/{siteId}";
        if (siteId === undefined || siteId === null)
    ...
    protected processGetSite(response: Response): Promise<SiteRes> {
        ...
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as SiteRes;
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SiteRes>(null as any);
    }
}
