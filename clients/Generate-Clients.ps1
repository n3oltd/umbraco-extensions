...
n3o-tool clients --url "https://localhost:6001/swagger/ContentTypes/swagger.json" --language "CSharp" --output-path "../src/N3O.Umbraco.Clients/Data/ContentTypes" --name "ContentTypesClient" --namespace "N3O.Umbraco.Clients.Data.ContentTypes"
...
n3o-tool clients --url "https://localhost:6001/swagger/DataTypes/swagger.json" --language "CSharp" --output-path "../src/N3O.Umbraco.Clients/Data/DataTypes" --name "DataTypesClient" --namespace "N3O.Umbraco.Clients.Data.DataTypes"
...
n3o-tool clients --url "https://localhost:6001/swagger/Exports/swagger.json" --language "CSharp" --output-path "../src/N3O.Umbraco.Clients/Data/Exports" --name "ExportsClient" --namespace "N3O.Umbraco.Clients.Data.Exports"
...
n3o-tool clients --url "https://localhost:6001/swagger/Imports/swagger.json" --language "CSharp" --output-path "../src/N3O.Umbraco.Clients/Data/Imports" --name "ImportsClient" --namespace "N3O.Umbraco.Clients.Data.Imports"
...
n3o-tool clients --url "https://localhost:6001/swagger/Giving/swagger.json" --language "CSharp" --output-path "../src/N3O.Umbraco.Clients/Giving" --name "GivingClient" --namespace "N3O.Umbraco.Clients.Giving"
...
n3o-tool clients --url "https://localhost:6001/swagger/Cart/swagger.json" --language "CSharp" --output-path "../src/N3O.Umbraco.Clients/Giving/Cart" --name "CartClient" --namespace "N3O.Umbraco.Clients.Giving.Cart"
...
n3o-tool clients --url "https://localhost:6001/swagger/Payments/swagger.json" --language "CSharp" --output-path "../src/N3O.Umbraco.Clients/Payments" --name "PaymentsClient" --namespace "N3O.Umbraco.Clients.Payments"
...
n3o-tool clients --url "https://localhost:6001/swagger/Opayo/swagger.json" --language "CSharp" --output-path "../src/N3O.Umbraco.Clients/Payments/Opayo" --name "OpayoClient" --namespace "N3O.Umbraco.Clients.Payments.Opayo"

n3o-tool clients --url "https://localhost:6001/swagger/PayPal/swagger.json" --language "TypeScript" --output-path "@n3oltd/umbraco-payments-paypal-client" --name "PayPalClient" --package-name "@n3oltd/umbraco-payments-paypal-client" --package-description "TODO"
n3o-tool clients --url "https://localhost:6001/swagger/PayPal/swagger.json" --language "CSharp" --output-path "../src/N3O.Umbraco.Clients/Payments/PayPal" --name "PayPalClient" --namespace "N3O.Umbraco.Clients.Payments.PayPal"
...
n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/feedbacks/docs/openapi/connect-v1.0.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "FeedbacksClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api --exclude-models-from "https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/umbraco-v1.0.json|https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/connect-v1.0.json"

n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/qurbanis/docs/openapi/umbraco-v1.0.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "QurbaniClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api --exclude-models-from "https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/umbraco-v1.0.json|https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/feedbacks/docs/openapi/connect-v1.0.json"

n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/sponsorships/docs/openapi/connect-v1.0.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "SponsorshipsClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api --exclude-models "ApiException" --exclude-models-from "https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/umbraco-v1.0.json|https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/feedbacks/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/qurbanis/docs/openapi/umbraco-v1.0.json"

n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/templates/docs/openapi/connect-v1.0.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "TemplatesClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api --exclude-models-from "https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/umbraco-v1.0.json|https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/feedbacks/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/qurbanis/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/sponsorships/docs/openapi/connect-v1.0.json"

n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/zakat/docs/openapi/umbraco-v1.0.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "ZakatClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api --exclude-models-from "https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/umbraco-v1.0.json|https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/feedbacks/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/qurbanis/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/sponsorships/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/templates/docs/openapi/connect-v1.0.json"

n3o-tool clients --url "https://beta.n3o.cloud/eu1/api/crowdfunding/docs/openapi/umbraco-v1.0.json" --language "CSharp" --output-path "../src/Cloud/N3O.Umbraco.Cloud.Platforms/Clients" --name "CrowdfundingClient" --namespace "N3O.Umbraco.Cloud.Platforms.Clients" --connect-api --exclude-models "ApiException" --exclude-models-from "https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/umbraco-v1.0.json|https://beta.n3o.cloud/eu1/api/platforms/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/feedbacks/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/qurbanis/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/sponsorships/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/templates/docs/openapi/connect-v1.0.json|https://beta.n3o.cloud/eu1/api/zakat/docs/openapi/umbraco-v1.0.json"