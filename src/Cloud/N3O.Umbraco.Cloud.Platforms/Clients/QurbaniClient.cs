...
namespace N3O.Umbraco.Cloud.Platforms.Clients
{
    ...
    public partial class PublishedOnBehalfOfSettings
    {

        [Newtonsoft.Json.JsonProperty("maxEntryLength", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? MaxEntryLength { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class PublishedQurbaniItems
    {

        [Newtonsoft.Json.JsonProperty("qurbaniItems", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<PublishedQurbaniItem> QurbaniItems { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class PublishedQurbaniSettings
    {
        ...
        public PublishedOnBehalfOfSettings OnBehalfOf { get; set; }
    ...
    public partial class QurbaniSeasonWebhookBodyReq
    {
        ...
        public QurbaniSeasonPlatformsSettingsReq Update { get; set; }
