...
namespace N3O.Umbraco.Cloud.Platforms.Clients
{
    ...
    public partial interface ISponsorshipsClient
    {
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ConnectAcquiredBeneficiariesRes> AcquireBeneficiariesAsync(string schemeId, ConnectAcquireBeneficiariesReq body);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ConnectAcquiredBeneficiariesRes> AcquireBeneficiariesAsync(string schemeId, ConnectAcquireBeneficiariesReq body, System.Threading.CancellationToken cancellationToken);

        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ConnectAvailableBeneficiariesRes> PreAcquireBeneficiariesAsync(string schemeId, ConnectPreAcquireBeneficiariesReq body);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ConnectAvailableBeneficiariesRes> PreAcquireBeneficiariesAsync(string schemeId, ConnectPreAcquireBeneficiariesReq body, System.Threading.CancellationToken cancellationToken);

    }

    [System.CodeDom.Compiler.GeneratedCode("NSwag", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class SponsorshipsClient : ISponsorshipsClient
    {
    ...
    #pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        public SponsorshipsClient(System.Net.Http.HttpClient httpClient)
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            BaseUrl = "/eu1/api/sponsorships";
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ConnectAcquiredBeneficiariesRes> AcquireBeneficiariesAsync(string schemeId, ConnectAcquireBeneficiariesReq body)
        {
            return AcquireBeneficiariesAsync(schemeId, body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ConnectAcquiredBeneficiariesRes> AcquireBeneficiariesAsync(string schemeId, ConnectAcquireBeneficiariesReq body, System.Threading.CancellationToken cancellationToken)
        {
            if (schemeId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "connect/v1.0/beneficiaries/{schemeId}/acquire"
                    urlBuilder_.Append("connect/v1.0/beneficiaries/");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ConnectAcquiredBeneficiariesRes>(response_, headers_, cancellationToken).ConfigureAwait(false);
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ConnectAvailableBeneficiariesRes> PreAcquireBeneficiariesAsync(string schemeId, ConnectPreAcquireBeneficiariesReq body)
        {
            return PreAcquireBeneficiariesAsync(schemeId, body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ConnectAvailableBeneficiariesRes> PreAcquireBeneficiariesAsync(string schemeId, ConnectPreAcquireBeneficiariesReq body, System.Threading.CancellationToken cancellationToken)
        {
            if (schemeId == null)
                throw new System.ArgumentNullException("schemeId");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "connect/v1.0/beneficiaries/{schemeId}/preacquire"
                    urlBuilder_.Append("connect/v1.0/beneficiaries/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(schemeId, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/preacquire");
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ConnectAvailableBeneficiariesRes>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ConnectAcquiredBeneficiariesRes
    {
        ...
        public System.Collections.Generic.ICollection<PublishedBeneficiary> Beneficiaries { get; set; }

    }

    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ConnectAvailableBeneficiariesRes
    {

        [Newtonsoft.Json.JsonProperty("beneficiaries", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<PublishedBeneficiary> Beneficiaries { get; set; }

        [Newtonsoft.Json.JsonProperty("alternativeIds", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<string> AlternativeIds { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class ConnectPreAcquireBeneficiariesReq
    {
        ...
        public ConnectAcquireBeneficiaryCriteria Criteria { get; set; }
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
        public SponsorshipCommitmentType? CommitmentType { get; set; }

        [Newtonsoft.Json.JsonProperty("commitmentDuration", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        [Newtonsoft.Json.JsonConverter(typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class PublishedBeneficiaryPlatformsThemeViews
    {

        [Newtonsoft.Json.JsonProperty("themeAlias", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class PublishedBeneficiaryPlatformsViews
    {
        ...
        public System.Collections.Generic.ICollection<PublishedBeneficiaryPlatformsThemeViews> Themes { get; set; }
    ...
    public partial class PublishedSponsorshipSchemeFundDimensionOptions
    {
        ...
        [Newtonsoft.Json.JsonProperty("locationFundDimension", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? LocationFundDimension { get; set; }
    ...
    /// <summary>
    /// One of 'availableBeneficiaries', 'beneficiary', 'sponsorshipScheme'
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum SponsorshipsPublishedFileKind
    {

        [System.Runtime.Serialization.EnumMember(Value = @"availableBeneficiaries")]
        AvailableBeneficiaries = 0,

        [System.Runtime.Serialization.EnumMember(Value = @"beneficiary")]
        Beneficiary = 1,

        [System.Runtime.Serialization.EnumMember(Value = @"sponsorshipScheme")]
        SponsorshipScheme = 2,

    }

    /// <summary>
    /// One of 'sponsorshipSchemes'
    /// </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.7.1.0 (NJsonSchema v11.6.1.0 (Newtonsoft.Json v13.0.0.0))")]
    public enum SponsorshipsSubscriptionFile
    {

        [System.Runtime.Serialization.EnumMember(Value = @"sponsorshipSchemes")]
