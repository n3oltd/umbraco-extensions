...
public class ScimPath {
    ...
    // A patch path is an attribute, optionally a filter over the members of a multi-valued attribute,
    // optionally a sub-attribute of whichever the filter selected: members[value eq "x"].display
